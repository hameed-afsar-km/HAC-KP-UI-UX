    ...
    <div className="max-w-[1400px] mx-auto space-y-8 pb-20 mt-4 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 animate-slide-in-up">
        <div className="space-y-2">
          ...
          <p className="text-sm text-[#5A6480] dark:text-[#A7A7A7] max-w-xl leading-relaxed">
        ...
        <Link
          href="/cases/1001"
          className="group relative inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-white dark:bg-black border border-[#E85002] text-[#E85002] hover:bg-[#E85002] hover:text-white font-bold rounded-xl transition-all duration-300 overflow-hidden"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          {/* Activity Log */}
          <div className="bg-white dark:bg-[#111111] border border-[#E2E6F0] dark:border-[#333333] rounded-3xl overflow-hidden shadow-sm dark:shadow-2xl dark:shadow-black/50">
            <div className="flex items-center justify-between px-6 py-5 border-b border-[#E2E6F0] dark:border-[#333333] bg-[#F6F7FB] dark:bg-[#000000]">
              <div className="flex items-center gap-3">
                <div className="flex gap-1.5">
                  <div className="w-3 h-3 rounded-full bg-[#E2E6F0] dark:bg-[#333333]" />
                  <div className="w-3 h-3 rounded-full bg-[#E2E6F0] dark:bg-[#333333]" />
                  <div className="w-3 h-3 rounded-full bg-[#E2E6F0] dark:bg-[#333333]" />
                </div>
                <h2 className="text-[12px] font-mono font-bold text-[#8B95AD] dark:text-[#A7A7A7] uppercase tracking-widest ml-2">System Log</h2>
              </div>
            </div>
            
            <div className="p-6">
              <div className="relative border-l-2 border-[#E2E6F0] dark:border-[#333333] ml-3 pl-6 space-y-8 py-2">
                {ACTIVITY.map((ev, idx) => {
                  const Icon = ev.icon;
                  ...
                  return (
                    <div key={idx} className="relative group">
                      <div className={`absolute -left-[31px] top-1 h-3.5 w-3.5 rounded-full border-2 border-white dark:border-[#111111] ${isResolved ? 'bg-[#E85002]' : 'bg-[#8B95AD] dark:bg-[#646464] group-hover:bg-[#A7A7A7]'} transition-colors`} />
                      
                      <div className="flex flex-col sm:flex-row sm:items-start gap-3">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <span className={`text-[13px] font-bold ${isResolved ? 'text-[#E85002]' : 'text-[#0D0F14] dark:text-[#F9F9F9]'}`}>{ev.label}</span>
                            <span className="text-[10px] font-mono text-[#8B95AD] dark:text-[#646464] bg-[#F6F7FB] dark:bg-[#000000] px-2 py-0.5 rounded-md border border-[#E2E6F0] dark:border-[#333333]">{ev.time}</span>
                          </div>
                          <p className="text-[13px] text-[#5A6480] dark:text-[#A7A7A7] leading-relaxed">{ev.desc}</p>
                        </div>
                        <div className={`flex-shrink-0 p-2 rounded-xl border ${isResolved ? 'bg-[#E85002]/10 border-[#E85002]/30 text-[#E85002]' : 'bg-[#F6F7FB] dark:bg-[#000000] border-[#E2E6F0] dark:border-[#333333] text-[#8B95AD] dark:text-[#646464]'}`}>
              ...
              {QUICK_TOOLS.map((tool) => {
                ...
                return (
                  <Link
                    key={tool.title}
                    href={tool.href}
                    className="group relative flex items-center justify-between p-4 bg-white dark:bg-[#111111] border border-[#E2E6F0] dark:border-[#333333] hover:border-[#E85002]/50 rounded-2xl transition-all duration-300"
                  >
                    ...
                    <ArrowUpRight size={14} className="text-[#8B95AD] dark:text-[#646464] group-hover:text-[#E85002] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" />
                  </Link>
                );
              })}
            </div>
            ...
            <div className="flex flex-col gap-1 px-2 pb-2">
              {cases.slice(0, 4).map((c) => (
                <Link
                  key={c.id}
                  href={`/cases/${c.id}`}
                  className="group flex flex-col p-4 bg-[#F6F7FB] dark:bg-[#000000] hover:bg-[#E2E6F0] dark:hover:bg-[#222222] rounded-2xl border border-transparent hover:border-[#E2E6F0] dark:hover:border-[#333333] transition-colors"
                >
