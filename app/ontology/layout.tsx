    ...
    <div className="space-y-6 animate-fade-up">
      ...
      <div className="bg-white dark:bg-[#111111] border border-[#E2E6F0] dark:border-[#333333] rounded-[2rem] overflow-hidden shadow-sm dark:shadow-2xl">
        <div className="px-6 py-4 border-b border-[#E2E6F0] dark:border-[#333333] bg-[#F6F7FB] dark:bg-[#000000]">
          <Breadcrumbs
            items={[
              { label: 'Ontology', href: '/ontology/entities' },
        ...
        <div className="px-8 py-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
          <div>
            <p className="text-[12px] font-mono font-bold text-[#8B95AD] dark:text-[#A7A7A7] uppercase tracking-widest">Ontology</p>
            <h1 className="text-3xl sm:text-4xl font-black text-[#0D0F14] dark:text-[#F9F9F9] mt-2">
              {isEntities ? 'Entity Types' : isRelationships ? 'Relationship Types' : 'Ontology'}
            </h1>
            <p className="text-[14px] text-[#555E6D] dark:text-[#A7A7A7] mt-2 max-w-xl">
              The categories ARGUS AI uses to identify and classify everything it finds in your files.
            </p>
          </div>
          <div className="flex items-center gap-3">
            <span className="px-3 py-1.5 rounded-lg text-[10px] font-mono font-bold uppercase tracking-wider bg-[#F6F7FB] dark:bg-[#000000] text-[#555E6D] dark:text-[#A7A7A7] border border-[#E2E6F0] dark:border-[#333333]">33 entity types</span>
            <span className="px-3 py-1.5 rounded-lg text-[10px] font-mono font-bold uppercase tracking-wider bg-[#F6F7FB] dark:bg-[#000000] text-[#555E6D] dark:text-[#A7A7A7] border border-[#E2E6F0] dark:border-[#333333]">18 relationship types</span>
          </div>
        </div>

        {/* Tabs */}
        <div className="px-8 pb-0 flex items-stretch gap-6 border-t border-[#E2E6F0] dark:border-[#333333] bg-[#F6F7FB] dark:bg-[#000000]">
          {[
              ...
              <Link
                ...
                className={`
                  ...
                  ${tab.active
                    ...
                    : 'text-[#8B95AD] dark:text-[#646464] hover:text-[#0D0F14] dark:hover:text-[#F9F9F9] border-b-2 border-transparent'
                  }
                `}
              >
